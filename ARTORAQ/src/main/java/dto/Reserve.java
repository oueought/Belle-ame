...
public class Reserve {
	...
	public Reserve(int book_id, String info_id, String customer_id, int book_number, int book_price, Date book_date,
			int book_acount) {
		super();
	...
	public String toString() {
		return "artOraqDTO [book_id=" + book_id + ", info_id=" + info_id + ", customer_id=" + customer_id
				+ ", book_number=" + book_number + ", book_price=" + book_price + ", book_date=" + book_date
